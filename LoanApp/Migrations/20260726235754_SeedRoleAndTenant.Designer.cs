...
namespace LoanApp.Migrations
{
    ...
    [Migration("20260726235754_SeedRoleAndTenant")]
    partial class SeedRoleAndTenant
    {
            ...
            modelBuilder.Entity("Models.LoanApproval", b =>
                {
                    ...
                    b.HasOne("Models.ReviewApplication", "ReviewApplication")
                        .WithMany()
                        .HasForeignKey("ReviewApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
